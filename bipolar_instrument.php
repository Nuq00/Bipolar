                        ...
                        <?php
                            ...
                            <div id="step8" style="display: none;">
                                ...
                                <div class="text-center">
                                    <button class="btn btn-primary col-lg-1 text-center" type="button" data-mdb-toggle="modal" data-mdb-target="#confirmModal1">Submit</button>
                                </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center">
                                    ...
                                    <div class="alert alert-danger d-flex flex-column justify-content-center align-items-center mt-2" role="alert">
                                        <h1>ALERT!!</h1>
                                        <div class="mt-2 text-center">
                                            <p>Warning: Blanks inputs can affect the final result calculation significantly. Please fill in all fields.</p>
                                        </div>
                                    </div>
                                </div>
