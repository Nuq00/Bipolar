...
<body>
                        ...
                        <div class="row col-lg-10 bg-dark mt-4 mb-3 text-light g-0 rounded-8 d-flex shadow-6-strong ">
                            ...
                            <div class="col-lg-6 px-4 my-3 ">
                                <div class="">
                                    ...
                                    } elseif ($bookings['fld_booking_status'] == 'Approved') {
                                    ...
                                    } elseif ($bookings['fld_booking_status'] == 'Done') {
                                        echo '<h6 class="text-uppercase">Status:&nbsp;&nbsp;&nbsp;<span class="badge bg-info">' . $bookings["fld_booking_status"] . '</span></h6>';
                                        echo '<h6 class="text-uppercase">Counsellor:&nbsp;&nbsp;&nbsp;' . $staff['fld_username'] . '</h6>';
                                    }
                                    ?>
                                </div>
                ...
                if ($daysDiff <= 31) { ?>
                    <div class="justify-content-center text-center d-flex justify-content-center">
                        <div class="row col-lg-10 bg-dark mt-4 mb-3 text-light g-0 rounded-8 d-flex shadow-6-strong">
                            ...
                            <div class="col-lg-6 px-4 my-3 ">
                                <div class="">
                                    ...
                                    if ($books['fld_booking_status'] == 'Pending') {
                                        ...
                                        echo '<h6 class="text-uppercase">Counsellor:&nbsp;&nbsp;&nbsp;<span class="badge badge-secondary">None</span></h6>';
                                    } elseif ($books['fld_booking_status'] == 'Approved') {
                                    ...
                                    } elseif ($books['fld_booking_status'] == 'Done') {
                                        echo '<h6 class="text-uppercase">Status:&nbsp;&nbsp;&nbsp;<span class="badge bg-Info">' . $books["fld_booking_status"] . '</span></h6>';
                                        echo '<h6 class="text-uppercase">Client:&nbsp;&nbsp;&nbsp;' . $user['fld_username'] . '</h6>';
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="col-lg-2 jusitfy-content-center text-center mx-3 ps-4 d-flex align-items-center">
                ...
                <div class="modal-footer">
                    <!-- <?php if ($category != 'Client') { ?>
                            <form id="addReportForm">
                                <button type="button" class="btn btn-success" >Add Report</button>
                            </form>
                        <?php } ?> -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#confirmDeleteBtn2').click(function() {
                var bookingID = $('#deleteModal').data('booking-id');

                // AJAX request to delete the booking
                $.ajax({
                    url: 'delete_booking2.php',
                    method: 'POST',
                    data: {
                        bookingID: bookingID
                    },
